...
public class TestBridgeFooterLinks {
	...
	// String contactSalesNumber =
	// driver.findElement(By.xpath("//*[@id=\"footer-top-links\"]/div/a[4]"))
	// .getAttribute("href");
	...
	// Assert.assertEquals(managementUrl,
	// "https://www.getbridge.com/features/continuous-1%3A1-management");
	//
	...
	// Assert.assertTrue(managementRedirectedPage.contains("Continuous 1:1
	// Management"));
	// }
	//
	// @Test(priority = 6)
	...
	// Assert.assertEquals(timelineModuleUrl,
	// "https://www.getbridge.com/features/employee-timeline");
	//
	// // verify timeline module redirected page contents
	// String timelineModuleRedirectedPage =
	// driver.findElement(By.className("feature-title")).getText();
	// Assert.assertTrue(timelineModuleRedirectedPage.contains("Employee
	// Timeline"));
	// }
	//
	// @Test(priority = 7)
	...
	// Assert.assertEquals(skillsAsseessmentUrl,
	// "https://www.getbridge.com/features/skills-assessment");
	//
	// // verify skills management redirected page contents
	// String skillsAssessmentRedirectedPage =
	// driver.findElement(By.className("feature-title")).getText();
	// Assert.assertTrue(skillsAssessmentRedirectedPage.contains("Skills
	// Assessment"));
	// }
	//
	// @Test(priority = 8)
	...
	// Assert.assertEquals(goalsAndTasksUrl,
	// "https://www.getbridge.com/features/goals-and-tasks");
	//
	// // verify goals and tasks redirected page contents
	// String goalsAndTasksRedirectedPage =
	// driver.findElement(By.className("feature-title")).getText();
	...
	// Assert.assertEquals(robustReportingUrl,
	// "https://www.getbridge.com/features/robust-reporting");
	//
	// // verify robust reporting redirected page contents
	// String robustReportingRedirectedPage =
	// driver.findElement(By.className("feature-title")).getText();
	// Assert.assertTrue(robustReportingRedirectedPage.contains("Robust
	// Reporting"));
	// }
	//
	// @Test(priority = 10)
	...
	// Assert.assertEquals(contentServicesUrl,
	// "https://www.getbridge.com/features/content-services");
	//
	// // verify content services redirected page contents
	// String contentServicesRedirectedPage =
	// driver.findElement(By.className("feature-title")).getText();
	// Assert.assertTrue(contentServicesRedirectedPage.contains("Content
	// Services"));
	// }
	//
	// @Test(priority = 12)
	...
	// Assert.assertEquals(offTheShelfCoursesUrl,
	// "https://www.getbridge.com/features/lms-content");
	//
	// // verify off the shelf courses redirected page contents
	// String offTheShelfCoursesRedirectedPage =
	// driver.findElement(By.className("feature-title")).getText();
	...
	// Assert.assertEquals(arcVideoUrl,
	// "https://www.getbridge.com/features/arc-video-for-bridge");
	//
	// // verify arc video redirected page contents
	// String arcVideoRedirectedPage =
	// driver.findElement(By.className("feature-title")).getText();
	...
	// Assert.assertEquals(learnFromYourLearningUrl,
	// "https://www.getbridge.com/features/learn-more");
	//
	// // verify learn more redirected page contents
	// String learnMoreRedirectedPage =
	// driver.findElement(By.className("feature-title")).getText();
	// Assert.assertTrue(learnMoreRedirectedPage.contains("Learn from your
	// Learning"));
	// }
	//
	// @Test(priority = 15)
	...
	// Assert.assertEquals(managerDashboardUrl,
	// "https://www.getbridge.com/features/manager-dashboard");
	//
	// // verify manager dashboard redirected page contents
	// String managerDashboardRedirectedPage =
	// driver.findElement(By.className("feature-title")).getText();
	// Assert.assertTrue(managerDashboardRedirectedPage.contains("Manager
	// Dashboard"));
	// }
	//
	// @Test(priority = 16)
	...
	// Assert.assertEquals(adminUrl,
	// "https://www.getbridge.com/features/admin-features");
	//
	// // verify admin redirected page contents
	// String adminRedirectedPage =
	// driver.findElement(By.className("feature-title")).getText();
	...
	// Assert.assertEquals(easyToUseUrl,
	// "https://www.getbridge.com/features/ease-of-use");
	//
	// // verify easy to use redirected page contents
	// String easyToUseRedirectedPage =
	// driver.findElement(By.className("feature-title")).getText();
	// Assert.assertTrue(easyToUseRedirectedPage.contains("Easy to Use, Easy to
	// Love"));
	// }
	//
	// @Test(priority = 18)
	...
	// Assert.assertEquals(anytimeAnywhereUrl,
	// "https://www.getbridge.com/features/learn-anywhere");
	//
	// // verify anytime anywhere redirected page contents
	// String anytimeAnywhereRedirectedPage =
	// driver.findElement(By.className("feature-title")).getText();
	// Assert.assertTrue(anytimeAnywhereRedirectedPage.contains("Anytime, Anywhere
	// Learning"));
	// }
	//
	// @Test(priority = 19)
	...
	// String contactTelNo =
	// driver.findElement(By.xpath("//*[@id=\"footer-phone\"]/a")).getAttribute("href");
	// Assert.assertEquals(contactTelNo, "tel:+1877.576.5364");
	//
	// String contactEmail =
	// driver.findElement(By.xpath("//*[@id=\"footer-email\"]/a")).getAttribute("href");
	// Assert.assertEquals(contactEmail, "mailto:info@getbridge.com");
	//
	// String contactLocationUrl =
	// driver.findElement(By.xpath("//*[@id=\"footer-address\"]/a")).getAttribute("href");
	// Assert.assertEquals(contactLocationUrl, "https://goo.gl/maps/zrKJGEnDyhu");
	//
	// String contactLocationText1 =
	// driver.findElement(By.xpath("//*[@id=\"footer-address\"]/a/text()[1]")).getText();
	// Assert.assertEquals(contactLocationText1, "6630 South 3000 east, Suite 700");
	//
	// String contactLocationText2 =
	// driver.findElement(By.xpath("//*[@id=\"footer-address\"]/a/text()[2]")).getText();
	...
	// String fbUrl =
	// driver.findElement(By.xpath("//*[@id=\"footer-social-icons\"]/a[1]")).getAttribute("href");
	// Assert.assertEquals(fbUrl, "https://www.facebook.com/GetBridge/");
	//
	// String twitterUrl =
	// driver.findElement(By.xpath("//*[@id=\"footer-social-icons\"]/a[2]")).getAttribute("href");
	// Assert.assertEquals(twitterUrl, "https://twitter.com/getbridge");
	//
	// String youtubeUrl =
	// driver.findElement(By.xpath("//*[@id=\"footer-social-icons\"]/a[3]")).getAttribute("href");
	// Assert.assertEquals(youtubeUrl, "https://www.youtube.com/user/bridgelms");
	//
	// String linkedinUrl =
	// driver.findElement(By.xpath("//*[@id=\"footer-social-icons\"]/a[4]")).getAttribute("href");
	// Assert.assertEquals(linkedinUrl,
	// "https://www.linkedin.com/showcase/get-bridge/");
	// }
	//
	// @Test(priority = 21)
	...
	// Assert.assertEquals(supportTermsUrl,
	// "https://www.getbridge.com/support-terms");
	//
	// // verify support terms redirected page contents
	// String supportTermsRedirectedPage =
	// driver.findElement(By.xpath("//*[@id=\"support-body-text\"]/div/div[1]/h3"))
	// .getText();
	...
	// Assert.assertEquals(bottomPrivacyPolicyUrl,
	// "https://www.instructure.com/policies/privacy/");
	//
	// // verify bottom privacy policy redirected page contents
	// String privacyPolicyRedirectedPage =
	// driver.findElement(By.id("spotMtext")).getText();
	// Assert.assertTrue(privacyPolicyRedirectedPage.contains("Instructure Privacy
	// Policy"));
	// }
	//
	// @Test(priority = 23)
	...
	// Assert.assertEquals(bottomTermsOfUseUrl,
	// "https://www.getbridge.com/policies/terms-of-use");
	//
	// // verify bottom terms of use redirected page contents
	// String supportTermsRedirectedPage =
	// driver.findElement(By.className("PRtitle2")).getText();
	...
	// Assert.assertEquals(bottomAccessibilityUrl,
	// "https://community.bridgeapp.com/docs/DOC-1629");
	//
	...
	// Assert.assertTrue(
	// bottomAccessibilityRedirectedPage.contains("Bridge Voluntary Product
	// Accessibility Template"));
	// Assert.assertTrue(bottomAccessibilityRedirectedPage.contains("Web Content
	...
	// Assert.assertEquals(bottomGDPRUrl,
	// "https://www.getbridge.com/policies/gdpr");
	//
	// // verify bottom GDPR redirected page contents
	// String bottomGDPRRedirectedPage =
	// driver.findElement(By.xpath("//*[@id=\"main\"]/h2[1]")).getText();
	// Assert.assertTrue(bottomGDPRRedirectedPage.contains("THE GENERAL DATA
	...
	// String bottomNewsRedirectedPage =
	// driver.findElement(By.xpath("//*[@id=\"news-hero\"]/h1")).getText();
